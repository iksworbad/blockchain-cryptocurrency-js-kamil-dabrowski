...
describe('Block', () => { 
    ...
    describe('mineBlock()', ()=>{
        ...
        it('creates a SHA-256 `hash` based on the proprt inputs', () => {
    ...
    describe('adjustDifficulty', () => {
        it('raises the difficulty for a quickly mined block', ()=> {
            expect(Block.adjustDifficulty({orginalBlock: block, timestamp: block.timestamp + MINE_RATE - 100})).toEqual(block.difficulty+1);
        });
